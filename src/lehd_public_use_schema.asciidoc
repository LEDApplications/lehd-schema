...
Every tabulation level is assigned a unique aggregation index, represented by the agg_level variable. The aggregation levels and characteristics are consistent acros
